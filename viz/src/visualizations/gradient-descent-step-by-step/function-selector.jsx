...
export default function FunctionSelector({
  ...
  return (
    <div className='order-3 lg:order-none bg-white p-2 md:p-3 rounded-lg md:rounded-xl shadow-sm border border-slate-200'>
      {/* Formula Readout */}
      <div className='bg-slate-100 border border-slate-200 rounded-lg p-2 md:p-3 flex flex-col gap-1 md:gap-1.5 shadow-inner mb-2 md:mb-3 overflow-x-auto'>
        <div className='flex items-center gap-2 min-w-0'>
          <span className='font-bold text-violet-600 font-mono text-xs md:text-sm shrink-0'>
            <TeX math='f(x)' />
          </span>
          <span className='text-slate-500 shrink-0'>=</span>
          <span className='text-slate-700 font-mono text-xs md:text-sm'>
      ...
      <div>
        ...
        <select
          ...
          className='w-full bg-white border border-slate-300 text-slate-900 text-xs md:text-sm rounded-lg p-1.5 md:p-2 shadow-sm focus:ring-violet-500 focus:border-violet-500'
        >
