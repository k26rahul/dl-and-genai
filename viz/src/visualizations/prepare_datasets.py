...
# Create a directory to store the JSON files (relative to this script's location)
output_dir = "datasets"
...
try:
  ...
  url_mpg = "https://archive.uci.edu/ml/machine-learning-databases/auto-mpg/auto-mpg.data"
